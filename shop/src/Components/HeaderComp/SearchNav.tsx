...
<div className="text-green-950 text-[32px]  font-medium font-primary leading-[38px]">Ecobazar</div>
</div>
...
<form>   
    <div className="relative w-[498px] h-[45px] rounded-md border border-neutral-200">
        ...
        <input type="search" id="default-search" className="block w-[498px] h-[45px] rounded-md  font-primary  p-4 pl-10 text-sm text-gray-900" placeholder="Search..." required/>
        <button type="submit" className="absolute top-0 right-0  h-[45px] px-6 py-1.5 bg-green-600  font-primary   text-white  rounded-r-lg  focus:ring-4 focus:outline-none focus:bg-green-800 dark:bg-green-800 hover:bg-green-800 dark:focus:bg-green-800">
               Search
...
<div className="w-[191px] h-[34px]flex justify-between items-center  inline-flex">
    ...
    <img src='src/assets/imges/Bag.png' className='w-[24px] h-[24px]' />
        ...
        <div className="flex-col justify-start items-start gap-[7px] inline-flex">
            <div className="text-neutral-600 text-[11px] font-normal font-primary leading-[13.20px]">Shopping cart:</div>
            <div className="text-zinc-900 text-sm font-medium font-primary leading-[14px]">$57.00</div>
        </div>
    </div>
</div>
