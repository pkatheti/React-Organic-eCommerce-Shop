...
export default function Categories() {
  ...
  <div className="w-28  text-zinc-100  font-primary text-sm font-medium  leading-[21px]">All Categories</div>
  <img src='src/assets/imges/Group.png'  className=" px-[3.75px]  justify-center items-center flex"/>
